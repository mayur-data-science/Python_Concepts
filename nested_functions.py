...
# *args (Non-Keyword Arguments): to pass a variable(any-no,less or more) number of arguments to a function from function call.
# **kwargs (Keyword Arguments) : to pass a variable(any-no,less or more) number of arguments to a function from function call.
...
# Passing Function's as an Argument's: (Higher Order Functions)
...
def higher_order_function(func1,func2): # func1 = fx , internally function aliasing happned.
...
def higher_order_function(func1,func2): # func1 = add , internally function aliasing happned.
    ...
    func1(num1,num2) # calling function add() having arguments by it aliase name func1
    # func1() # TypeError: add() missing 2 required positional arguments: 'num1' and 'num2' 
    func2(num1,num2) # calling function sub() having arguments by it aliase name func2
...
def add(num1,num2): # add declared
    print("inside add function")
    print(num1+num2)

def sub(num1,num2): # sub declared
